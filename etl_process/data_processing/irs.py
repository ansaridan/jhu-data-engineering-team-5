...
irs_data = pd.read_csv('./IRS_Data_2021.csv', header=0, dtype={'zipcode': str})
...
data_dict = ny_df.to_dict(orient='records')
...
codes = [
    ...
    {'Code': 'VRTCRIND', 'Description': 'Number of returns with virtual currency indicator'},
    {'Code': 'N2', 'Description': 'Number of individuals'}, 
    {'Code': 'TOTAL_VITD', 'Description': 'Total number of volunteer prepared returns'}, 
    {'Code': 'VITA', 'Description': 'Number of volunteer income tax assistance prepared returns'},
    {'Code': 'TCE', 'Description': 'Number of tax counseling for the elderly prepared returns'}, 
    {'Code': 'VITA_EIC', 'Description': 'Number of volunteer prepared returns with Earned Income Credit'}, 
    ...
    {'Code': 'N00700', 'Description': 'Number of returns with state and local income tax refunds'}, 
    {'Code': 'A00700', 'Description': 'State and local income tax refunds amount'},
    {'Code': 'N00900', 'Description': 'Number of returns with business or professional net income (less loss)'}, 
    {'Code': 'A00900', 'Description': 'Business or professional net income (less loss) amount'}, 
    {'Code': 'N01000', 'Description': 'Number of returns with net capital gain (less loss)'}, 
    {'Code': 'A01000', 'Description': 'Net capital gain (less loss) amount'},
    {'Code': 'N01400', 'Description': 'Number of returns with taxable individual retirement arrangements distributions'}, 
    {'Code': 'A01400', 'Description': 'Taxable individual retirement arrangements distributions amount'}, 
    {'Code': 'N01700', 'Description': 'Number of returns with taxable pensions and annuities'},
    {'Code': 'A01700', 'Description': 'Taxable pensions and annuities amount'}, 
    {'Code': 'SCHF', 'Description': 'Number of farm returns'}, 
    {'Code': 'N02300', 'Description': 'Number of returns with unemployment compensation'}, 
    {'Code': 'A02300', 'Description': 'Unemployment compensation amount'}, 
    {'Code': 'N02500', 'Description': 'Number of returns with taxable Social Security benefits'},
    {'Code': 'A02500', 'Description': 'Taxable Social Security benefits amount'}, 
    {'Code': 'N26270', 'Description': 'Number of returns with partnership/S-corp net income (less loss)'}, 
    {'Code': 'A26270', 'Description': 'Partnership/S-corp ne income (less loss) amount'}, 
    {'Code': 'N02900', 'Description': 'Number of returns with total statutory adjustments'},
    ...
    {'Code':'N03330', 'Description': 'Number of returns with Self-employed (Keogh) retirement plans'}, 
    {'Code':'A03300', 'Description': 'Self-employed (Keogh) retirement plans amount'},
    {'Code':'N03270', 'Description': 'Number of returns with Self-employed health insurance deduction amount'}, 
    {'Code':'A03270', 'Description': 'Self-employed health insurance deduction amount'}, 
    {'Code':'N03150', 'Description': 'Number of returns with individual retirement arrangement payments'}, 
    {'Code':'A03150', 'Description': 'Individual retirement arrangement payments amount'},
    {'Code':'N03210', 'Description': 'Number of returns with student loan interest deduction'}, 
    {'Code':'A03210', 'Description': 'Student loan interest deduction amount'}, 
    {'Code':'N02910', 'Description': 'Number of returns with charitable contributions if took standard deduction'}, 
    {'Code':'A02910', 'Description': 'Charitable contributions if took standard deduction'},
    {'Code':'N04450', 'Description': 'Number of returns with total standard deduction'}, 
    {'Code':'A04450', 'Description': 'Total standard deduction amount'}, 
    {'Code':'N04100', 'Description': 'Number of returns with basic standard deduction'}, 
    {'Code':'A04100', 'Description': 'Basic standard deduction amount'}, 
    {'Code':'N04200', 'Description': 'Number of returns with additional standard deduction'}, 
    ...
    {'Code':'N17000', 'Description': 'Number of returns with total medical and dental expense deduction'}, 
    {'Code':'A17000', 'Description': 'Total medical and dental expense deduction amount'}, 
    {'Code':'N18425', 'Description': 'Number of returns with state and local income taxes'}, 
    {'Code':'A18425', 'Description': 'State and local income taxes amount'},
    {'Code':'N18450', 'Description': 'Number of returns with state and local general sales tax'}, 
    ...
    {'Code':'N18460', 'Description': 'Number of returns with limited state and local taxes'}, 
    ...
    {'Code':'N19300', 'Description': 'Number of returns with home mortgage interest paid'}, 
    {'Code':'A19300', 'Description': 'Home mortgage interest paid amount'}, 
    {'Code':'N19500', 'Description': 'Number of returns with home mortgage from personal seller'}, 
    ...
    {'Code':'N19550', 'Description': 'Number of returns with qualified mortgage insurance premiums'}, 
    {'Code':'A19550', 'Description': 'Qualified mortgage insurance premiums amount'}, 
    {'Code':'N19570', 'Description': 'Number of returns with investment interest paid'}, 
    {'Code':'A19570', 'Description': 'Investment interest paid amount'},
    {'Code':'N19700', 'Description': 'Number of returns with total charitable contributions'}, 
    {'Code':'A19700', 'Description': 'Total charitable contributions amount'},
    {'Code':'N20950', 'Description': 'Number of returns with other non-limited miscellanous deductions'}, 
    {'Code':'A20950', 'Description': 'Other non-limited miscellaneous deductions amount'}, 
    {'Code':'N04475', 'Description': 'Number of returns with qualified business income deduction'}, 
    ...
    {'Code':'N05800', 'Description': 'Number of returns with income tax before credits'}, 
    ...
    {'Code':'N05780', 'Description': 'Number of returns with excess advance premium tax credit repayment'},
    {'Code':'A05780', 'Description': 'Excess advance premium tax credit repayment amount'}, 
    ...
    {'Code':'N07180', 'Description': 'Number of returns with child and dependent care credit'},
    {'Code':'A07180', 'Description': 'Child and dependent care credit amount'}, 
    {'Code':'N07230', 'Description': 'Number of returns with nonrefundable education credit'},
    {'Code':'A07230', 'Description': 'Nonrefundable education credit amount'},
    {'Code':'N07240', 'Description': 'Number of returns with retirement savings contribution credit'}, 
    {'Code':'A07240', 'Description': 'Retirement savings contribution credit amount'}, 
    {'Code':'N07225', 'Description': 'Number of returns with nonrefundable child and other dependent credit'},
    {'Code':'A07225', 'Description': 'Nonrefundable child and other dependent credit amount'},
    {'Code':'N07260', 'Description': 'Number of returns with residental energy tax credit'},
    ...
    {'Code':'N85770', 'Description': 'Number of returns with total premium tax credit'},
    {'Code':'A85770', 'Description': 'Total premium tax credit amount'}, 
    {'Code':'N85775', 'Description': 'Number of returns with advance premium tax credit'}, 
    ...
    {'Code':'N59720', 'Description': 'Number of returns with excess earned income credit'}, 
    {'Code':'A59720', 'Description': 'Excess earned income credit (refundable) amount'}, 
    {'Code':'N11070', 'Description': 'Number of returns with refundable child tax credit or additional child tax credit'}, 
    {'Code':'A11070', 'Description': 'Refundable child tax credit or additional child tax credit amount'},
    {'Code':'N10960', 'Description': 'Number of returns with refundable education credit'}, 
    ...
    {'Code':'N11450', 'Description': 'Number of returns with qualified sick and family leave credit for leave taken before April 1, 2021'}, 
    {'Code':'A11450', 'Description': 'Qualified sick and family leave credit for leave taken before April 1, 2021'}, 
    {'Code':'N11520', 'Description': 'Number of returns with refundable child and dependent care credit'},
    {'Code':'A11520', 'Description': 'Refundable child and dependent care credit'},
    {'Code':'N11530', 'Description': 'Number of returns with qualified sicka dn family leave credit for leave taken afte March 31, 2021'},
    {'Code':'A11530', 'Description': 'Qualified sick and family leave credit for leave taken after March 31, 2021'},
    ...
    {'Code':'N10971', 'Description': 'Number of returns with economic impact payment third round'}, 
    {'Code':'A10971', 'Description': 'Economic impact payment third round amount'}, 
    {'Code':'N06500', 'Description': 'Number of returns with income tax after credits'}, 
    ...
    {'Code':'N85300', 'Description': 'Number of returns with net investment income tax'}, 
    {'Code':'A85300', 'Description': 'Net investment income tax amount'}, 
    {'Code':'N11901', 'Description': 'Number of returns with tax due at time of filing'}, 
    ...
    {'Code':'N12000', 'Description': 'Number of returns with credit to next year\'s estimated tax'}, 
...
c.execute('''CREATE TABLE IF NOT EXISTS irs_data.ny_irs_data 
            (id SERIAL PRIMARY KEY, STATEFIPS VARCHAR(50), STATE TEXT, zipcode INTEGER, agi_stub NUMERIC, N1 NUMERIC, mars1 NUMERIC, MARS2 NUMERIC, MARS4                    NUMERIC, ELF NUMERIC, CPREP NUMERIC, PREP NUMERIC, DIR_DEP NUMERIC, VRTCRIND NUMERIC, N2 NUMERIC, TOTAL_VITA NUMERIC, VITA NUMERIC, TCE NUMERIC, 
...
c.execute('''CREATE TABLE IF NOT EXISTS irs_data.irs_codes
